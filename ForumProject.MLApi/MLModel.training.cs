...
namespace ForumProject.MLApi
{
    ...
    {
        public const string RetrainFilePath =  @"D:\School\ForumProject\ForumProject.MLApi\sentiment_data.csv";
        ...
        {
            return mlContext.Data.LoadFromTextFile<ForumProject_MLApi.MLModel.ModelInput>(inputDataFilePath, separatorChar, hasHeader, allowQuoting: allowQuoting);
        }
